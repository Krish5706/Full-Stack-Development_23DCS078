        ...
        <aside className="sidebar">
            ...
            <div className="card user-card">
                ...
                <div>
                    ...
                    {/* CHANGE 1: Added className="muted" to the email */}
                ...
                <div className="chats">
                    {searchTerm.trim() ? (
                        ...
                        recentChats.map(chat => (
                            <div key={chat.id} className="chat-row" onClick={() => onSelectChat({ chatId: chat.chatId, otherUser: { uid: chat.otherUid, name: chat.otherName, photo: chat.otherPhoto } })}>
